...
var Button = React.forwardRef(
  (_a, ref) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      isLoading ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Loader2, { className: "mr-2 h-4 w-4 animate-spin" }), children) : children
    );
  }
);
...
var ToastClose = React6.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React6.createElement(
    ...
    /* @__PURE__ */ React6.createElement(X, { className: "h-4 w-4" })
  );
});
